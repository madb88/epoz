...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'knp_disqus.helper' => 'getKnpDisqus_HelperService',
            'knp_disqus.request' => 'getKnpDisqus_RequestService',
            'knp_disqus.twig' => 'getKnpDisqus_TwigService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'epoz2', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40639d22e6608f1c7fd35fdb12ad0711da99688f5ce8744cf96d9a9007d5d6a7');
    ...
    /**
     * Gets the 'knp_disqus.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\DisqusBundle\Templating\Helper\DisqusHelper A Knp\Bundle\DisqusBundle\Templating\Helper\DisqusHelper instance.
     */
    protected function getKnpDisqus_HelperService()
    {
        return $this->services['knp_disqus.helper'] = new \Knp\Bundle\DisqusBundle\Templating\Helper\DisqusHelper($this->get('templating'), $this->get('knp_disqus.request'), 'dev');
    }

    /**
     * Gets the 'knp_disqus.request' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\DisqusBundle\Disqus A Knp\Bundle\DisqusBundle\Disqus instance.
     */
    protected function getKnpDisqus_RequestService()
    {
        return $this->services['knp_disqus.request'] = new \Knp\Bundle\DisqusBundle\Disqus($this, 'ahEF5LgPRtHmTT8LQoOesLWQ4QEGPTXNJwU43Rp3XWO9vo8kuC283rapKcV3UZfF', 'lWuagYmEAYROQtZxeMy1aoikZcxrp2TmAtsCT1r3jjXqx1JP1PbZeSiSCMCuddn9', '', true);
    }

    /**
     * Gets the 'knp_disqus.twig' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\DisqusBundle\Twig\Extension\DisqusExtension A Knp\Bundle\DisqusBundle\Twig\Extension\DisqusExtension instance.
     */
    protected function getKnpDisqus_TwigService()
    {
        return $this->services['knp_disqus.twig'] = new \Knp\Bundle\DisqusBundle\Twig\Extension\DisqusExtension($this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('knp_disqus.twig'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-disqus-bundle\\Knp\\Bundle\\DisqusBundle/Resources/views'), 'KnpDisqus');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'KnpDisqusBundle' => 'Knp\\Bundle\\DisqusBundle\\KnpDisqusBundle',
            ...
            'knp_disqus.api_key' => 'ahEF5LgPRtHmTT8LQoOesLWQ4QEGPTXNJwU43Rp3XWO9vo8kuC283rapKcV3UZfF',
            'knp_disqus.secret_key' => 'lWuagYmEAYROQtZxeMy1aoikZcxrp2TmAtsCT1r3jjXqx1JP1PbZeSiSCMCuddn9',
            'knp_disqus.lorem.shortname' => 'epoz',
            'locale' => 'en',
            ...
            'knp_disqus.forums' => array(
                0 => 'epoz',
            ),
            'knp_disqus.base_url' => '',
            'knp_disqus.debug' => 1,
            'knp_disqus.helper.class' => 'Knp\\Bundle\\DisqusBundle\\Templating\\Helper\\DisqusHelper',
            'knp_disqus.twig.class' => 'Knp\\Bundle\\DisqusBundle\\Twig\\Extension\\DisqusExtension',
            'knp_disqus.api.class' => 'Knp\\Bundle\\DisqusBundle\\Disqus',
