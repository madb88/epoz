...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'charts', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addChart(\AppBundle\Entity\Charts $chart)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addChart', array($chart));

        return parent::addChart($chart);
    }
    ...
    public function removeChart(\AppBundle\Entity\Charts $charts)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeChart', array($charts));

        return parent::removeChart($charts);
    }
    ...
    public function getCharts()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCharts', array());

        return parent::getCharts();
    }
